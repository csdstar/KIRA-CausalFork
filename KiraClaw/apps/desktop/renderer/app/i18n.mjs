...
const translations = {
  en: {
    ...
    mcp: {
      ...
      browserDesc: "Browser MCP uses the Chrome profile in your workspace.",
    ...
    diagnostics: {
      ...
      responseTraceTitle: "Response Trace",
      responseTraceSubtitle: "Append developer trace details to final channel replies.",
      responseTraceToggle: "Final channel trace",
      responseTraceStatus: "Channel replies can include Used, elapsed time, background sessions, and warnings.",
      responseTraceSaving: "Saving response trace setting...",
      responseTraceEnabledStatus: "Final channel trace is on.",
      responseTraceDisabledStatus: "Final channel trace is off.",
    ...
    settings: {
      ...
      fullDiskAccessTitle: "Full Disk Access",
      fullDiskAccessDesc: "Open macOS Settings and enable Full Disk Access for KiraClaw if you want fewer file and network volume permission prompts.",
      fullDiskAccessGranted: "Granted",
      fullDiskAccessNotGranted: "Not Granted",
      fullDiskAccessUnknown: "Unknown",
      fullDiskAccessUnsupported: "macOS Only",
      fullDiskAccessGrantedStatus: "KiraClaw can already access protected macOS locations.",
      fullDiskAccessUnknownStatus: "KiraClaw has not checked Full Disk Access yet.",
      fullDiskAccessUnsupportedStatus: "Full Disk Access guidance is available on macOS only.",
    ...
    status: {
      ...
      openingFullDiskAccessSettings: "Opening Full Disk Access settings...",
      fullDiskAccessSettingsOpened: "Full Disk Access settings opened.",
      fullDiskAccessSettingsFailed: "Failed to open Full Disk Access settings: {{message}}",
      relaunchingApp: "Restarting KiraClaw...",
      ...
      resettingLogin: "Resetting {{service}} login state...",
      loginResetRestarting: "{{service}} login state was reset. Restarting KIRA Engine...",
      loginResetComplete: "{{service}} login state was reset.",
      loginResetCompleteWithNote: "{{service}} login state was reset. {{note}}",
      loginResetRestarted: "{{service}} login state was reset and KIRA Engine restarted.",
      loginResetRestartFailed: "{{service}} login state was reset, but engine restart failed.",
      loginResetBannerRestarting: "Restarting KIRA Engine...",
      loginResetBannerRestarted: "KIRA Engine restarted.",
      loginResetBannerRestartFailed: "KIRA Engine restart failed.",
      loginResetFailed: "{{service}} login reset failed: {{message}}",
      ms365SystemCacheNote: "If sign-in still persists, the OS credential cache may still be active.",
  ...
  ko: {
    ...
    mcp: {
      ...
      browserTitle: "브라우저",
      browserDesc: "브라우저 MCP는 워크스페이스의 Chrome 프로필을 사용합니다.",
    ...
    diagnostics: {
      ...
      responseTraceTitle: "응답 추적",
      responseTraceSubtitle: "채널 최종 응답에 개발자용 추적 정보를 덧붙입니다.",
      responseTraceToggle: "채널 최종 응답 추적",
      responseTraceStatus: "채널 응답에 Used, 경과 시간, 백그라운드 세션, 경고를 함께 표시할 수 있습니다.",
      responseTraceSaving: "응답 추적 설정을 저장하는 중...",
      responseTraceEnabledStatus: "채널 최종 응답 추적이 켜졌습니다.",
      responseTraceDisabledStatus: "채널 최종 응답 추적이 꺼졌습니다.",
    ...
    settings: {
      ...
      fullDiskAccessTitle: "전체 디스크 접근 권한",
      fullDiskAccessDesc: "파일과 네트워크 볼륨 권한 팝업을 줄이려면 macOS 설정에서 KiraClaw의 Full Disk Access를 켜세요.",
      fullDiskAccessGranted: "허용됨",
      fullDiskAccessNotGranted: "허용 안 됨",
      fullDiskAccessUnknown: "확인 필요",
      fullDiskAccessUnsupported: "macOS 전용",
      fullDiskAccessGrantedStatus: "KiraClaw가 보호된 macOS 위치에 이미 접근할 수 있습니다.",
      fullDiskAccessUnknownStatus: "KiraClaw가 아직 Full Disk Access 상태를 확인하지 못했습니다.",
      fullDiskAccessUnsupportedStatus: "Full Disk Access 안내는 macOS에서만 제공됩니다.",
    ...
    status: {
      ...
      openingFullDiskAccessSettings: "Full Disk Access 설정 여는 중...",
      fullDiskAccessSettingsOpened: "Full Disk Access 설정을 열었습니다.",
      fullDiskAccessSettingsFailed: "Full Disk Access 설정 열기 실패: {{message}}",
      relaunchingApp: "KiraClaw를 재시작하는 중...",
      ...
      resettingLogin: "{{service}} 로그인 상태를 초기화하는 중...",
      loginResetRestarting: "{{service}} 로그인 상태를 초기화했고 KIRA 엔진을 재시작하는 중입니다...",
      loginResetComplete: "{{service}} 로그인 상태를 초기화했습니다.",
      loginResetCompleteWithNote: "{{service}} 로그인 상태를 초기화했습니다. {{note}}",
      loginResetRestarted: "{{service}} 로그인 상태를 초기화했고 KIRA 엔진도 재시작했습니다.",
      loginResetRestartFailed: "{{service}} 로그인 상태를 초기화했지만 엔진 재시작은 실패했습니다.",
      loginResetBannerRestarting: "엔진 재시작 중...",
      loginResetBannerRestarted: "엔진 재시작 완료.",
      loginResetBannerRestartFailed: "엔진 재시작 실패.",
      loginResetFailed: "{{service}} 로그인 초기화 실패: {{message}}",
      ms365SystemCacheNote: "로그인이 계속 유지되면 운영체제 자격 증명 캐시가 아직 남아 있을 수 있습니다.",
